...
# @Last Modified time: 2023-03-20 12:55:31
mismathes="0 1 2 3"
...
do
    ...
    mpirun -n 8 ./ParDRe -i ${data_set1_fullpath} -p ${data_set2_fullpath} -m ${mis_n} -o ${output_file1_fullpath} -r ${output_file2_fullpath}
done
